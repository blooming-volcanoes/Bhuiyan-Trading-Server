...
const { createProduct, getProduct, getByCategoryId, deleteProduct, getSingleProduct, getBySubCategory, updateProduct } = require('../../controller/product/productController');
